...
private:
 ...
 void load();void save();bool connect();void callback(char*,byte*,unsigned int);void publishZoneDiscovery(uint8_t);void publishNumberDiscovery(uint8_t);void publishSwitchDiscovery();void publishStatusDiscovery();friend void mqttCallbackBridge(char*,byte*,unsigned int);
};
